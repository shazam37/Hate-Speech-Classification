...
class DataTransformation:
    ...
    def imbalance_data_cleaning(self):
        try:
            logging.info("Entered into the imbalance data cleaning mode")
            ...
            logging.info(f"Exited the data cleaning mode and returned imbalance data {imbalance_data}")
    ...
    def raw_data_cleaning(self):
        ...
        try:
            logging.info("Entered into the raw data cleaning mode")
            ...
            logging.info(f"Exited the raw data cleaning mode and returned the raw data {raw_data}")
            return raw_data
    ...
    def concat_dataframe(self):
        ...
        try:
            logging.info("Entered the concat dataframe mode")
    ...
    def concat_data_cleaning(self, words):
        try:
            logging.info("Entered into the concat data cleaning mode")
            ...
            words = " ".join(words)
            logging.info("Exited the concat data cleaning mode")
            return words
        except Exception as e:
            raise CustomException(e,sys) from e
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifacts:
        try:
            logging.info("Entered into the initiate data transformation mode")
