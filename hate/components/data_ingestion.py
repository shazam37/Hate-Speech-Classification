...
class DataIngestion:
    ...
    def get_data_from_gcloud(self) -> None:
        try:
            logging.info('Inside the get_data_from_cloud method of data ingestion library')
            ...
            logging.info("Exited the get_data_from_gcloud_method of Data Ingestion Class")

        except Exception as e:
            raise CustomException(e,sys) from e
        
    def unzip_and_clean(self):
        logging.info("Entered the unzip and clean method of the Data ingestion class")
        try:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        try:
            ...
            logging.info("Fetched the data from the gcloud bucket")
